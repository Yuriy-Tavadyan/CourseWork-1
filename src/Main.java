public class Main {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee("Коршиков Иван Александрович", 1, 2100);
        Employee employee2 = new Employee("Тавадян Юрий Артурович", 2, 2200);
        Employee employee3 = new Employee("Суркова Татьяна Олеговна", 3, 2300);
        Employee employee4 = new Employee("Жорин Андрей Михайлович", 4, 2400);
        Employee employee5 = new Employee("Чалый Георгий Леонидович", 5, 2500);
        Employee employee6 = new Employee("Теплов Александр Павлович", 1, 2200);
        Employee employee7 = new Employee("Тавадян Алексей Артурович", 2, 2100);
        Employee employee8 = new Employee("Хмара Даниил Германович", 3, 2000);
        Employee employee9 = new Employee("Стасикян Самвел Стасикович", 4, 1700);
        Employee employee10 = new Employee("Мешков Максим Александрович", 5, 2800);
